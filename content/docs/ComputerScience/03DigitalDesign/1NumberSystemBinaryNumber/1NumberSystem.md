...
title: "数字系统"
# 【必填】文章发布日期
date: 2025-09-20T12:12:43+08:00
# 【建议】文章最后修改日期：更新文章后，请手动更新此日期，以告知搜索引擎内容已更新
lastmod: 2025-09-20T12:12:43+08:00
...
description: "记数系统（numeral system，system of numeration）又称记数法、记数制度、数制，是使用一组數字符号来表示數的体系。记数可以俗称为“写数”，以区别同音词计数。"
# 【建议SEO】文章关键词：针对本文的特定关键词，用逗号分隔
keywords: ["记数系统", "数字系统", "数字电路", "二进制数"]
